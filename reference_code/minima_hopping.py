...
def optimize(
    atoms, optimizer=optimizer, fmax=0.02
):  # I should really check what fmax does
...
if __name__ == "__main__":
    ...
    write(
        "minima/start.xyz",
        Atoms("Fe" + str(number_of_atoms), positions=atoms.get_positions()),
    )
    ...
    write(
        "minima/end.xyz", Atoms("Fe" + str(number_of_atoms), positions=best_positions)
    )
